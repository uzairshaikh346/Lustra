    ...
    <div>
      <section id="About" className="text-gray-600 body-font bg-black/90">
        <div className="container px-5 py-24 mx-auto">
          <h1 className="about-title text-3xl md:text-5xl font-medium title-font text-[#FFB22C] mb-12 text-center">
            About us
          </h1>
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="about-card h-full bg-black p-8 rounded">
                ...
                <p className="leading-relaxed mb-6 md:text-xl text-gray-200">
